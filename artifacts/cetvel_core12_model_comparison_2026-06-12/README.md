...
| Run | Tokenizer | CETVEL job | Slice | Core-11 macro | Delta vs raw BPE | XQuAD F1 | Delta vs raw BPE |
| --- | --- | ---: | --- | ---: | ---: | ---: | ---: |
| Raw BPE d20 | `bpe_32768` | `493293` | tasks 01-13 archived; common tasks 01-12 used here | 0.4514 | +0.0000 | 3.0985 | +0.0000 |
| MorphBPE + TRmorph d20 | `morphbpe_trmorph_32768` | `494056` | core tasks 01-12 | 0.4541 | +0.0027 | 3.4786 | +0.3801 |
| MorphBPE + Zemberek d20 | `morphbpe_zemberek_32768` | `494057` | core tasks 01-12 | 0.4618 | +0.0104 | 3.2633 | +0.1648 |
